...
<body>
    <nav class="navbar navbar-dark fixed-top">
        ...
        <div class="navbarbot container justify-content-center">
            <ul class="nav">
                ...
                <li class="ms-3">
                    <a class="nav-link" href="data_desa.php">Data Desa</a>
                </li>
                <li class="ms-3">
                ...
                <?php else: ?>    
                    <li class="ms-3 logout">
                        <a class="nav-link" href="logout.php" name="logout" onclick="return confirm('Apakah anda yakin ingin logout?');"><i class="fa-regular fa-user"></i>Logout</a>
                    </li>
                <?php endif; ?>
                ...
                <div class="col-3">
                    <div class="logo">
                        <img src="assets/vendor/img/logo gorontalo barat.png" alt="logo Kabupaten gorontalo utara"
                            title="Kab. Gorontalo Utara" height="220px" >
                    </div>
                </div>
                <div class="garis">
                    <br>
    ...
    <section id="berita">
        <div class="header">
            <h1 class="ms-4 mt-3">PENGUMUMAN</h1>
        </div>
        <div class="container mt-5 mb-5">
            <div class="row align-items-center">
                ...
                <div class="col-md-15 text-start">
                    <div class="card mb-3">
                        <div class="row g-0">
                            <div class="profil col-md-2 mt-5 ms-4">
                                <img src="assets/vendor/img/orang.png" alt="" width="150px"
                                ...
                                <div class=" col-md-9">
                                    <div class="card-body">
                                        ...
                                        <p contenteditable="true">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam
                                            ...
                                            impedit voluptas fugit vitae, sunt quos veritatis.
                                        </p>
                                        <p class="card-text"><small class="text-muted">Last updated - mins ago</small>
                                        </p>
                                    </div>
                                </div>
                            <?php else : ?>
    ...
    <section id="galeri">
        <div class="header mt-3">
            <h1 class="ms-4 mt-3">GALERI DESA</h1>
        </div>
        <div class="container text-center">
            <div class="row align-items-center">
                ...
                <div class="col mt-5">
                    <div class="row align-items-center">
                        <div class="col mt-3">
                            <img src="assets/vendor/img/batujin (galeridesa).jpeg" alt="" height="110px">
                        </div>
                        <div class="col mt-3">
                            <img src="assets/vendor/img/kantor desa.jpeg" height="110px" alt="" height="110px">
                        </div>
                        <div class="col mt-3">
                            <img src="assets/vendor/img/paud (galeri desa).jpeg" alt="" height="110px">
                        </div>
                    </div>
                    <div class="row align-items-center">
                        <div class="col mt-3">
                        ...
                        <div class="col mt-3">
                            <img src="assets/vendor/img/pantai(galeridesa).jpeg" height="110px" alt="" height="110px" >
                        </div>
                        <div class="col mt-3">
